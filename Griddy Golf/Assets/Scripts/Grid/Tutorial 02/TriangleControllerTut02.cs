...
public class TriangleControllerTut02 : MonoBehaviour {
	...
	public BounceSoundTut02 bounceSound;
	...
	public TileDotsControllerTut02 tileDotsController;
	...
	void Update () {
		...
		if (tutorialCtrl1.inTutorialMV && doNotCreateDot) {
			if ((GameObject.Find ("Adjust Helper Dot 2.1") != null) && 
			    (GameObject.Find ("Adjust Helper Dot 2.1").transform.position.z == 27.7f)) {
				if (gridDots [0] != null && gridDots [0].transform.position.x == 6.0f && gridDots [0].transform.position.z == 28.2f) {
					gridDots [0].GetComponent<ManipulateVerticesTut02> ().startBlinking = true;
				} else if (gridDots [1] != null && gridDots [1].transform.position.x == 6.0f && gridDots [1].transform.position.z == 28.2f) {
					gridDots [1].GetComponent<ManipulateVerticesTut02> ().startBlinking = true;
				} else if (gridDots [2] != null && gridDots [2].transform.position.x ==6.0f && gridDots [2].transform.position.z == 28.2f) {
					gridDots [2].GetComponent<ManipulateVerticesTut02> ().startBlinking = true;
				}
			} else if ((GameObject.Find ("Adjust Helper Dot 2.2") != null) && 
			           (GameObject.Find ("Adjust Helper Dot 2.2").transform.position.x == 1.0f)) {
				if (gridDots [0] != null && gridDots [0].transform.position.x == 2.5) {
					gridDots [0].GetComponent<ManipulateVerticesTut02> ().startBlinking = true;
				} else if (gridDots [1] != null && gridDots [1].transform.position.x == 2.5) {
					gridDots [1].GetComponent<ManipulateVerticesTut02> ().startBlinking = true;
				} else if (gridDots [2] != null && gridDots [2].transform.position.x == 2.5f) {
					gridDots [2].GetComponent<ManipulateVerticesTut02> ().startBlinking = true;
				}
			}
		}
	...
	public void RecreateGridDot (GameObject tempGridDot) {
		Vector3 recreatedTileDotPos = tempGridDot.transform.position;
		Debug.Log ("Recreate Dot");
		int i = 0;
		while (true) {
			if (gridDots [i].transform.position == currentGridDot.transform.position) {
	...
	void CreateTriangle () {
		...
		col1.gameObject.AddComponent<BounceSoundTut02> ();
		col2.gameObject.AddComponent<BounceSoundTut02> ();
		col3.gameObject.AddComponent<BounceSoundTut02> ();
		
		BounceSoundTut02 bounce1 = col1.gameObject.GetComponent<BounceSoundTut02> ();
		BounceSoundTut02 bounce2 = col2.gameObject.GetComponent<BounceSoundTut02> ();
		BounceSoundTut02 bounce3 = col3.gameObject.GetComponent<BounceSoundTut02> ();
		
		bounce1.SetInfo ();
		bounce2.SetInfo ();
		bounce3.SetInfo ();

		col1.gameObject.AddComponent<AnglesTextTut02> ();
		col2.gameObject.AddComponent<AnglesTextTut02> ();
		col3.gameObject.AddComponent<AnglesTextTut02> ();
		...
		col1.gameObject.GetComponent<AnglesTextTut02> ().SetAngle (angle1);
		col2.gameObject.GetComponent<AnglesTextTut02> ().SetAngle (angle2);
		col3.gameObject.GetComponent<AnglesTextTut02> ().SetAngle (angle3);
	...
	public bool SelectTriangleLines (float lengthOfLine, GameObject selectedTriangleLine, float selectedTriangeLineAngle, string nameOfLine) {
		if (numOfSelectedLines == 0) {
			...
			if (foundLine) {
				...
				float temp = thirdSelectedLine.GetComponent<AnglesTextTut02> ().angleOfLine;
